...
const BookingAdding = ({ refreash }) => {
    ...
    const handlesearchTables = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.get(`https://localhost:7073/api/Table/GetAvailableTables/${guestAttending}`);
    ...
    const handleFetchAvailableTimes = async (tableId) => {
        ...
        try {
            const response = await axios.get(`https://localhost:7073/api/Booking/GetBookingByTableIdAndDate/${tableId}/${date}`);
    ...
    async function handleSubmit(e) {
        ...
        try {
            await axios.post('https://localhost:7073/api/Booking/AddBooking', booking)
